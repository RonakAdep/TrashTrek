...
app.post('/send', upload.single('attachment'), (req, res) => {
    ...
    const message = "We have detected some trash in the area and wanted to bring it to your attention.Attached, you will find a file containing more information regarding the detected trash, including its location and any additional details that may be helpful for further action.";
    ...
    fetch(apiURL)
        ...
        .then(data => {
            ...
            const mailOptions = {
                from: email,
                to: 'ronakadep@gmail.com', // Recipient email address
